...
public class UnitRepository {
    ...
    public void update(Long unitId, UnitCreateDto dto) {
        context.update(UNIT)
                .set(UNIT.UNIT_TYPE_ID, dto.getUnitType().getId())
