...
import org.example.components.domain.Indexes;
import org.example.components.domain.Keys;
import org.example.components.domain.Public;
import org.example.components.domain.tables.records.FlywaySchemaHistoryRecord;
import org.jooq.*;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
    ...
    private static final long serialVersionUID = -2027835067;
