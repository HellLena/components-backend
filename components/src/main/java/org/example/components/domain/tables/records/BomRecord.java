...
public class BomRecord extends UpdatableRecordImpl<BomRecord> implements Record9<Long, Integer, String, Integer, Integer, Integer, Boolean, Boolean, String> {

    private static final long serialVersionUID = -551245508;
     ...
     */
    public void setFootprintId(Integer value) {
        set(4, value);
    }
    ...
    @Override
    public Row9<Long, Integer, String, Integer, Integer, Integer, Boolean, Boolean, String> valuesRow() {
    ...
    @Override
    public BomRecord value2(Integer value) {
        setUnitId(value);
        return this;
    }
    ...
    @Override
    public BomRecord value4(Integer value) {
        setElementId(value);
        return this;
    }

    @Override
    public BomRecord value5(Integer value) {
    ...
    @Override
    public BomRecord values(Long value1, Integer value2, String value3, Integer value4, Integer value5, Integer value6, Boolean value7, Boolean value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BomRecord(Long id, Integer unitId, String designator, Integer elementId, Integer footprintId, Integer quantity, Boolean fitted, Boolean canBeReplaced, String status) {
        super(Bom.BOM);
